 ...
 * @param month: string
 */
export function baseNavi(year: string, month: string): NavigateAction[] {
    return [
        // 初期画面遷移
        {
...
/**
 * 全レース結果表示までのナビゲーター
 * @param base NavigateAction[]
 * @param target string
 */
export function goalNavi(base: NavigateAction[], target: string): NavigateAction[] {
    return [
        ...base,
        // onclick属性クリック
        {
